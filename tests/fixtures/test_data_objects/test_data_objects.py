...
def config_dict():
    """Function to give config dict for testing"""
    return {
        "library_version": 1.0,
        "default_settings": {"start_row": 1, "start_column": 1},
        "worksheets": [
            {"sheet_name": "books", "settings": {"name": "books", "end_column": 3}},
            {
                "sheet_name": "publisher",
                "settings": {"name": "publisher", "end_column": 2},
            },
        ],
    }
...
def expected_conversion_result():
    """Function to return expected transpilation of a_workbook workbook"""
    return {
        "books": [
            {
